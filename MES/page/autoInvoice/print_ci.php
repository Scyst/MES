...
<div class="a4-page">
    ...
    <table class="items-table">
        <thead>
            <tr>
                <th style="width: 20%;">SHIPPING MARKS</th>
                <th style="width: 12%;">CARTON NO.</th>
                <th style="width: 38%;">DESCRIPTION</th>
                <th style="width: 10%;">QUANTITY<br>(CARTON)</th>
                <th style="width: 10%;">UNIT PRICE<br>(USD)</th>
                <th style="width: 10%;">AMOUNT<br>(USD)</th>
            </tr>
        </thead>
        <tbody>
            <?php 
            ...
            <tr>
                ...
                <td class="text-end fw-bold"><?= number_format($row['line_total'], 2) ?></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
        <tfoot>
            <tr class="bg-light">
                ...
                <td></td>
                <td class="text-end fw-bold" style="text-decoration: underline double;"><?= number_format($sumTotal, 2) ?></td>
            </tr>
        </tfoot>
    </table>
...
<script>
    // สั่งเปิดหน้าต่าง Print อัตโนมัติเมื่อโหลดหน้าเว็บเสร็จ
