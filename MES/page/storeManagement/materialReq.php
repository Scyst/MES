...
<body class="layout-top-header">
    ...
    <div class="page-container">
        <main id="main-content" class="container-fluid px-3 px-lg-4 pt-3 pb-5">
            ...
            <div class="bg-white rounded-3 shadow-sm p-2 p-md-3 mb-3 border">
                <div class="row g-2 align-items-center">
                    
                    <div class="col-12 col-md-5 col-lg-3">
                        <div class="input-group shadow-sm">
                            <span class="input-group-text bg-light text-primary border-end-0"><i class="fas fa-search"></i></span>
                            <input type="text" id="searchItem" class="form-control border-start-0" placeholder="ค้นหารหัส SAP, ชื่อ..." autocomplete="off">
                        </div>
                    </div>
                    
                    <div class="col-12 col-md-7 col-lg-9 d-flex flex-wrap gap-2 align-items-center justify-content-md-between">
                        
                        <div class="d-flex gap-2 flex-grow-1 flex-md-grow-0">
                            <select id="sortItem" class="form-select shadow-sm fw-bold border-secondary-subtle text-dark" style="width: 140px; flex-shrink: 0; font-size: 0.85rem;" onchange="loadCatalog()">
                            ...
                            <button id="toggleImageBtn" class="btn btn-light border shadow-sm text-secondary text-nowrap" onclick="toggleImages()" style="flex-shrink: 0;">
                                <i class="fas fa-image-slash"></i> <span class="ms-1">ซ่อนรูป</span>
                            </button>
                        </div>

                        <div class="d-flex gap-2 overflow-auto hide-scrollbar flex-grow-1 flex-md-grow-0 justify-content-md-end">
                            <button class="btn btn-outline-primary shadow-sm fw-bold text-nowrap rounded-pill px-3" onclick="openHistoryModal()" style="height: 38px; flex-shrink: 0;">
                                <i class="fas fa-history"></i> <span class="d-none d-sm-inline ms-1">ประวัติของฉัน</span>
                            </button>
                            
                            <div class="category-chip active" onclick="filterCategory('ALL', this)">All Items</div>
                            <div class="category-chip" onclick="filterCategory('RM', this)"><i class="fas fa-cubes me-1 text-primary"></i> RM</div>
                            <div class="category-chip" onclick="filterCategory('CONSUMABLE', this)"><i class="fas fa-pump-soap me-1 text-success"></i> Consumables</div>
                            <div class="category-chip" onclick="filterCategory('SPARE', this)"><i class="fas fa-cogs me-1 text-danger"></i> Spare</div>
                            <div class="category-chip" onclick="filterCategory('PKG', this)"><i class="fas fa-box me-1 text-warning"></i> PKG</div>
                        </div>
                    </div>
            ...
            <div class="row g-2 g-md-3 g-lg-4" id="catalogGrid"></div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 16px;">
                ...
                <div class="modal-body p-0">
                    <div class="bg-light px-3 pt-2 pb-3 border-bottom">
