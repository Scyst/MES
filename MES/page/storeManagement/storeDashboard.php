...
<head>
    ...
    <style>
        ...
        .split-layout-height { height: calc(100vh - 95px); }
        ...
        @media (max-width: 991.98px) {
            body { overflow: auto; } 
            .split-layout-height { height: auto; }
            #left-pane { min-height: calc(100vh - 80px); }
            #right-pane { min-height: calc(100vh - 80px); padding-bottom: 80px;}
...
<body class="layout-top-header">
        ...
        <main id="main-content" class="px-2 px-lg-3 pt-3">
            <div class="row g-3 split-layout-height">
                ...
                <div class="col-12 col-lg-4 col-xl-3 d-flex flex-column h-100" id="left-pane">
                    ...
                    <div class="list-group list-group-flush border rounded-3 shadow-sm flex-grow-1 overflow-auto hide-scrollbar bg-white p-2 gap-2" id="orderListContainer">
                        </div>
                </div>
                ...
                <div class="col-12 col-lg-8 col-xl-9 d-none d-lg-flex flex-column h-100" id="right-pane">
                    <div class="bg-white border rounded-3 shadow-sm flex-grow-1 d-flex flex-column overflow-hidden position-relative">
                        ...
                        <div id="empty-state" class="flex-grow-1 d-flex flex-column align-items-center justify-content-center text-muted opacity-50">
                            ...
                            <h4>เลือกรายการด้านซ้ายเพื่อดูรายละเอียด</h4>
                        </div>
    ...
    <input type="hidden" id="current_dashboard_mode" value="STOCK"> <script src="../../utils/libs/jquery-3.6.0.min.js"></script>
