...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function renderTable(documents) {
        ...
        documents.forEach(doc => {
            ...
            tr.innerHTML = `
                <td><i class="fas fa-file-alt me-2 text-secondary"></i> ${escapeHTML(doc.file_name)}</td>
    ...
    function setupPagination(paginationData) {
        ...
        createPaginationControls(paginationControls, paginationData.currentPage, paginationData.totalPages, (page) => fetchDocuments(page, currentSearchTerm));
    }
    ...
    function openDetailModal(docId) {
        ...
        contentEl.innerHTML = `
            <dl class="row">
                <dt class="col-sm-3">File Name</dt><dd class="col-sm-9">${escapeHTML(doc.file_name)}</dd>
