...
<head>
    ...
    <style>
        /* Custom Styles สำหรับหน้า Manpower เฉพาะส่วน */
        .card-kpi {
            border: none;
            border-radius: 12px;
        ...
        /* Cursor Pointer for Drill-down rows */
        ...
        <div class="container-fluid py-4" style="max-width: 1600px;">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex gap-2">
                    ...
                    <button class="btn btn-success shadow-sm" onclick="App.syncNow()" title="ดึงข้อมูลจาก Cloud">
                    ...
                    <button class="btn btn-warning shadow-sm fw-bold text-dark" onclick="Actions.openShiftPlanner()" title="จัดการกะการทำงาน (Shift Rotation)">
                        <i class="fas fa-people-arrows me-1"></i> Shift Manager
                    </button>
