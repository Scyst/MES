<?php
// MES/page/managementCopy/api/planManage.php
...
$planTable  = 'PRODUCTION_PLANS_TEST'; 
$itemTable  = 'ITEMS';                 
    ...
    switch ($action) {
        case 'get_plans':
            ...
            $actualsSubQuery = "
                ...
                FROM $transTable t
                JOIN LOCATIONS l ON t.to_location_id = l.location_id
        ...
        case 'calculate_carry_over':
            try {
                ...
                // 🔴 แก้ไข: ข้ามการตรวจสอบ config และระบุ SP _TEST ตรงๆ
                $spName = 'sp_UpdatePlanCarryOver_TEST';
        ...
        case 'import_plans_bulk':
            ...
            try {
                ...
                // 🔴 แก้ไข: Hardcode ตาราง MANUFACTURING_ROUTES
