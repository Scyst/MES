        ...
        <li>
            ...
            <div class="collapse" id="collapseWh" data-bs-parent="#desktopAccordionMenu">
                <ul class="list-unstyled ms-3 ps-2 border-start py-1">
                    ...
                    <li><a class="dropdown-item-icon py-1" href="../storeManagement/inventoryDashboard.php"><i class="fas fa-boxes fa-fw"></i><span>Inventory Stock</span></a></li>
                    <?php endif; ?>
        ...
        <li>
            ...
            <div class="collapse" id="collapseQa" data-bs-parent="#desktopAccordionMenu">
                <ul class="list-unstyled ms-3 ps-2 border-start py-1">
                    ...
                    <li><a class="dropdown-item-icon py-1" href="../PE/peTechMobile.php"><i class="fas fa-wrench fa-fw"></i><span>PE Tech (Mobile)</span></a></li>
                </ul>
            </div>
        </li>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="globalMobileMenu">
    ...
    <div class="offcanvas-body p-0">
        ...
        <div class="list-group list-group-flush" id="mobileAccordionMenu">
            ...
            <a class="list-group-item list-group-item-action text-dark" href="../storeManagement/inventoryDashboard.php"><i class="fas fa-boxes fa-fw me-3"></i> Inventory Stock</a>
            <?php endif; ?>
