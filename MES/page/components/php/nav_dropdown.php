<nav class="sidebar" id="sidebar">
    ...
    <ul class="custom-dropdown">
        ...
        <li><a class="dropdown-item-icon" href="../inventoryUI/inventoryUI.php" title="Inventory Management"><i class="fas fa-boxes fa-fw"></i><span>Inventory Management</span></a></li>
        <li><a class="dropdown-item-icon" href="../pdTable/pdTable.php" title="Production & WIP (Legacy)"><i class="fas fa-table fa-fw"></i><span>Production & WIP (Old)</span></a></li>
        ...
        ?>
        <li><a class="dropdown-item-icon" href="../performanceReport/performanceReportUI.php" title="Operator Performance"><i class="fas fa-user-check fa-fw"></i><span>Operator Performance</span></a></li>
        <?php endif; ?>
