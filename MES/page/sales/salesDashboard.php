                    ...
                    <div class="col-6 col-md-4 col-lg-20-percent">
                        <div class="card shadow-sm kpi-card" onclick="filterData('WAIT_LOAD')" id="card-wait-load">
                            <div class="card-body p-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <div class="text-uppercase text-body-secondary small fw-bold mb-1">Ready to Load</div>
                    ...
                    <div class="card-body p-2 bg-body-tertiary rounded">
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div class="d-none d-xl-flex align-items-center summary-bar border border-secondary-subtle rounded px-3 py-1 me-2 shadow-sm bg-body">
                                    <span class="badge bg-dark me-2" id="sum-containers">0</span> <span class="small text-body-secondary fw-bold me-3" style="font-size: 0.8rem;">Orders</span>
                                    
                                    <span class="badge bg-info text-dark me-2" id="sum-qty">0</span> <span class="small text-body-secondary fw-bold me-3" style="font-size: 0.8rem;">Pcs</span>

                                    <div class="vr me-3 opacity-25"></div>

                                    <span class="fw-bold text-success font-monospace me-3" id="sum-amount" style="font-size: 1rem;">฿0.00</span>

                                    <div class="vr me-2 opacity-25"></div>

                                    <div class="d-flex align-items-center" title="Exchange Rate">
                                        <span class="small text-body-secondary me-2">1$ =</span>
                                        <input type="number" id="exchangeRate" 
                                               class="form-control form-control-sm text-end fw-bold text-primary px-1 border-secondary-subtle bg-body" 
                                               value="32" step="0.01" 
                                               style="height: 24px; width: 60px; font-size: 0.85rem;"> 
                                    </div>
                                </div>

                                <div class="btn-group">
                                    <button class="btn btn-light border-secondary-subtle text-secondary" onclick="document.getElementById('fileInput').click()" data-bs-toggle="tooltip" title="Import Excel">
                                        <i class="fas fa-file-import"></i>
                                    </button>
                                    <button class="btn btn-light border-secondary-subtle text-secondary" onclick="exportData()" data-bs-toggle="tooltip" title="Export Excel">
                        ...
                        <table class="table table-bordered table-hover align-middle mb-0 text-nowrap">
                            <thead class="sticky-top shadow-sm">
                                <tr class="text-center align-middle">
                                    ...
                                    <th class="ps-3 border-start sortable bg-body" data-sort="is_confirmed" 
                                    ...
                                    <th class="text-center sortable" data-sort="quantity">Qty <i class="sort-icon fas fa-sort text-secondary opacity-50 ms-1"></i></th>
                                    
                                    <th class="sortable" data-sort="dc_location">DC <i class="sort-icon fas fa-sort text-secondary opacity-50 ms-1"></i></th>
                                    <th class="sortable" data-sort="loading_week">Load Wk <i class="sort-icon fas fa-sort text-secondary opacity-50 ms-1"></i></th>
                                    <th class="sortable" data-sort="shipping_week">Ship Wk <i class="sort-icon fas fa-sort text-secondary opacity-50 ms-1"></i></th>
                                    
                                    <th class="text-center bg-warning bg-opacity-10 sortable" data-sort="production_date">
                                        Prod Date <i class="sort-icon fas fa-sort text-secondary opacity-50 ms-1"></i>
                                    </th>
                                    <th class="text-center bg-warning bg-opacity-10 sortable" data-sort="is_production_done" style="width: 70px;">
                                        Done? <i class="sort-icon fas fa-sort text-secondary opacity-50 ms-1"></i>
                                    </th>
                                    
                                    <th class="text-center bg-info bg-opacity-10 sortable" data-sort="loading_date">
                                        Load Date <i class="sort-icon fas fa-sort text-secondary opacity-50 ms-1"></i>
                                    </th>
                                    <th class="text-center bg-info bg-opacity-10 sortable" data-sort="is_loading_done" style="width: 70px;">
                                        Loaded? <i class="sort-icon fas fa-sort text-secondary opacity-50 ms-1"></i>
                                    </th>
                                    
                                    <th class="text-center bg-purple bg-opacity-10 sortable" data-sort="inspection_date">
                                        Insp Date <i class="sort-icon fas fa-sort text-secondary opacity-50 ms-1"></i>
                                    </th>
                                    <th class="text-center bg-purple bg-opacity-10 sortable" data-sort="inspection_status" style="width: 70px;">
                                        Pass? <i class="sort-icon fas fa-sort text-secondary opacity-50 ms-1"></i>
                                    </th>
                                    
                                    <th class="sortable" data-sort="ticket_number">Ticket <i class="sort-icon fas fa-sort text-secondary opacity-50 ms-1"></i></th>
                                    <th class="text-end sortable" data-sort="price">Price (THB) <i class="sort-icon fas fa-sort text-secondary opacity-50 ms-1"></i></th>
                                    <th class="sortable" data-sort="remark">Remark <i class="sort-icon fas fa-sort text-secondary opacity-50 ms-1"></i></th>
                                </tr>
                            </thead>
