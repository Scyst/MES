...
define('JOB_ORDERS_TABLE', IS_DEVELOPMENT ? 'JOB_ORDERS_TEST' : 'JOB_ORDERS');
...
// --- Maintanance Tables ---
define('MT_ITEMS_TABLE', IS_DEVELOPMENT ? 'MT_ITEMS_TEST' : 'MT_ITEMS');
define('MT_LOCATIONS_TABLE', IS_DEVELOPMENT ? 'MT_LOCATIONS_TEST' : 'MT_LOCATIONS');
define('MT_ONHAND_TABLE', IS_DEVELOPMENT ? 'MT_INVENTORY_ONHAND_TEST' : 'MT_INVENTORY_ONHAND');
define('MT_TRANSACTIONS_TABLE', IS_DEVELOPMENT ? 'MT_TRANSACTIONS_TEST' : 'MT_TRANSACTIONS');
