...
define('SMTP_USER', 'scystApp@gmail.com');
define('SMTP_PASS', 'morvryrbrxwrifgw');
define('SMTP_PORT', 587);
define('SMTP_SECURE', 'tls');
define('EMAIL_FROM', 'scystApp@gmail.com');
define('EMAIL_FROM_NAME', 'MES Maintenance Report');
define('EMAIL_TO_REPORT', 'naphat-noo@sncformer.com'); 
define('EMAIL_CC_REPORT', 'napat33025@gmail.com');
...
define('BASE_URL', IS_DEVELOPMENT 
    ...
    : 'https://oem.sncformer.com/iot-toolbox/sandbox-b9/MES/MES'
);

define('SYSTEM_API_KEY', 'MESKey2026');
