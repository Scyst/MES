...
(
    ...
    GROUP BY ISNULL(L.actual_line, E.line), ISNULL(S.shift_name, 'Unknown'), ISNULL(L.actual_team, E.team_group), COALESCE(CM.category_name, E.position, 'Other'), ISNULL(CM.rate_type, 'DAILY'), ISNULL(TS.hc_group, 'MAIN')
)
GO
