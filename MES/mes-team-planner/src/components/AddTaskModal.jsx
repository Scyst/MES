              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="flex gap-2">
                    <input lang="th-TH" disabled={!isEditable} type="date" name="startDate" value={formData.startDate || ''} onChange={handleChange} className="flex-[3] w-full min-w-0 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-xl px-2 sm:px-3 py-2.5 outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all text-sm relative z-10" />
                    <TimeInput24 disabled={!isEditable} name="startTime" value={formData.startTime || '09:00'} onChange={handleChange} className="flex-[2] w-full min-w-0 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-xl px-2 sm:px-3 py-2.5 outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all text-sm relative z-10" />
                  </div>
                </div>
                <div>
                  <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2 flex items-center gap-2">
                  ...
                  <div className="flex gap-2">
                    <input lang="th-TH" disabled={!isEditable} type="date" name="dueDate" value={formData.dueDate || ''} onChange={handleChange} className="flex-[3] w-full min-w-0 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-xl px-2 sm:px-3 py-2.5 outline-none focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10 transition-all text-sm relative z-10" />
                    <TimeInput24 disabled={!isEditable} name="endTime" value={formData.endTime || '18:00'} onChange={handleChange} className="flex-[2] w-full min-w-0 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-xl px-2 sm:px-3 py-2.5 outline-none focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10 transition-all text-sm relative z-10" />
                  </div>
                </div>
              </div>
