  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-5 gap-3 shrink-0">
        {/* Due Today */}
        <div className="xl:col-span-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm rounded-2xl p-4 flex flex-col h-[300px]">
        ...
        <div className="xl:col-span-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm rounded-2xl p-4 flex flex-col h-[300px]">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-5 gap-3 shrink-0 pb-3">
        {/* Activity Feed */}
        <div className="xl:col-span-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-4 flex flex-col h-[220px]">
          <div className="flex items-center gap-2 mb-3">
        ...
        <div className="xl:col-span-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm rounded-xl p-4 flex flex-col h-[220px]">
          <div className="flex items-center gap-2 mb-3">
