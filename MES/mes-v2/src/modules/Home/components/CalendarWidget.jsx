  ...
  return (
    <div className="flex flex-col">
      <div className="flex items-center gap-2 mb-4 mt-2">
        ...
        <h3 className="font-bold text-gray-800 text-lg">ปฏิทินงาน <span className="font-normal text-gray-500 text-sm ml-1 tracking-wide">({todayDate})</span></h3>
      </div>
      
      <div className="border border-gray-200 rounded-2xl bg-white overflow-hidden shadow-[0_2px_8px_rgba(0,0,0,0.03)]">
        <div className="grid grid-cols-7 text-center text-xs font-bold text-gray-500 bg-gray-50/80 py-3 border-b border-gray-100">
